...
1. **Image herunterladen** (v1.6.2): [boatos_v1.6.2.img.gz](https://archive.org/download/boatos-distri-image/boatos_v1.6.2.img.gz) (~7,5 GB)
...
- ~~Verteilbares Pi-Image~~ ✅ [Fertig-Image verfügbar](https://archive.org/download/boatos-distri-image/boatos_v1.6.2.img.gz)
