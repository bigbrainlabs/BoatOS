...
const translations = {
    de: {
        ...
        about_thanks: "Danke an",
        about_partners: "Partner",
        about_pcbway_what: "Sponsert die Platinenfertigung für BoatOpenIO.",
        about_pcbway_order: "Platinen direkt bestellen",
        about_links: "Links",
        about_support: "Unterstützen",
        about_license: "Lizenz",
        about_sources: "Datenquellen",
        about_disclaimer_h: "Haftungsausschluss",
        about_disclaimer: "BoatOS wird ohne jede Gewähr bereitgestellt („as is“), die Nutzung erfolgt auf eigenes Risiko. Für Schäden an Hard- oder Software, am Boot, an Personen oder für Folgeschäden wird keine Haftung übernommen. BoatOS ersetzt keine amtlichen Seekarten und keine sorgfältige Navigation — verlasse dich niemals allein auf diese Software.",
        about_loading: "Wird geladen…",
        about_no_sponsors: "Noch keine Einträge — oder offline.",
    ...
    en: {
        ...
        about_partners: "Partner",
        about_pcbway_what: "Sponsors the PCB manufacturing for BoatOpenIO.",
        about_pcbway_order: "Order the boards directly",
        about_links: "Links",
        about_support: "Support",
        about_license: "License",
        about_sources: "Data sources",
        about_disclaimer_h: "Disclaimer",
        about_disclaimer: "BoatOS is provided without any warranty (“as is”); use at your own risk. No liability is accepted for damage to hardware or software, to the vessel, to persons, or for consequential damage. BoatOS is not a substitute for official nautical charts or careful navigation — never rely on this software alone.",
        about_loading: "Loading…",
        about_no_sponsors: "No entries yet — or offline.",
        // Settings panel - section headers
