...
const translations = {
    de: {
        ...
        settings_elwis_desc: "Offizielle Binnenschifffahrtskarten von ELWIS",
        loading_ellipsis: "Wird geladen…",
        uploading_ellipsis: "Hochladen…",
        upload_arrow: "⬆ Hochladen",
        routing_region_h: "Routing-Region",
        routing_region_desc: "Welcher Routing-Graph im OSRM-Dienst geladen ist. Der Wechsel ist neustartfest.",
        routing_active_label: "Aktiv:",
        routing_switch: "Wechseln",
        routing_data_h: "Routing-Daten (grenzüberschreitend)",
        routing_data_desc: ".routing-Dateien aus dem MBTiles Creator hochladen — ermöglicht Routen über Ländergrenzen.",
        routing_choose_file: "📂 .routing-Datei wählen",
        routing_osrm_server: "OSRM Server",
        routing_server_url: "Server-URL",
        routing_api_key: "API-Key",
        routing_gh_free_ph: "Kostenlos auf graphhopper.com",
        routing_gh_register: "🔗 API-Key bei graphhopper.com registrieren (500 Anfragen/Tag kostenlos)",
        routing_current_desc: "Berücksichtigt Fließgeschwindigkeiten für genauere ETA-Berechnungen",
        routing_waterways_h: "Gewässer",
        routing_add_waterway: "+ Gewässer",
        routing_geo_hint: "Strömung in <strong>km/h</strong>. Über 🌍 auch die Geografie setzen: die <em>Bounding-Box</em> grenzt ein, wo das Gewässer liegen kann, die <em>Mündung</em> bestimmt die Fließrichtung (berg/tal). Leere Geo-Felder = eingebauter Standard.",
        routing_default_by_type: "Standard nach Typ",
        type_river: "Fluss",
        type_canal: "Kanal",
        type_stream: "Bach",
        type_lake: "See",
        routing_calc_info: "<strong>ℹ️ Berechnung:</strong><br>• Stromabwärts: Geschwindigkeit + Strömung<br>• Stromaufwärts: Geschwindigkeit − Strömung<br>• Live-Daten von PEGELONLINE (falls verfügbar)",
        ...
        data_lock_db_desc: "Verwalte die Schleusen-Datenbank: OSM-Import, Datenanreicherung und Qualitätsprüfung.",
        data_import_osm_desc: "Lädt Schleusen aus OpenStreetMap für alle aktiven Karten-Regionen",
        data_enrich_desc: "Ergänzt VHF-Kanäle, Kontaktdaten und weitere Infos",
        data_quality_desc: "Zeigt Statistiken zur Datenqualität (VHF-Abdeckung, Kontakte, etc.)",
        data_verify_desc: "Prüft alle Schleusen-Positionen gegen OpenStreetMap und korrigiert Fehler (>500m Abweichung)",
        data_quality_report_h: "📊 Datenqualität",
        // Dashboard-Editor
        dash_tab_visual: "🎨 Visuell",
        dash_tab_code: "📝 Code",
        dash_tab_sensors: "📡 Sensoren",
        dash_mqtt_hint: "Alle bekannten MQTT-Topics. Veraltete Einträge hier entfernen.",
        dash_refresh: "🔄 Aktualisieren",
        dash_loading: "Wird geladen…",
        dash_topic_remove_confirm: "Topic entfernen?",
        dash_error: "Fehler",
        dash_choose_widget: "Widget-Typ wählen",
        dash_w_sensor: "Sensor-Karte",
        dash_w_sensor_desc: "Zeigt den aktuellen Wert als Karte",
        dash_w_gauge_desc: "Zeiger- oder Bogenanzeige",
        dash_cancel: "Abbrechen",
        dash_apply: "✓ Übernehmen",
        dash_reset: "↺ Zurücksetzen",
        dash_no_sensors_known: "Keine Sensoren bekannt.",
        dash_no_sensors_load: "Keine Sensoren — öffne den Sensoren-Tab zum Laden.",
        dash_special_label: "Spezial",
        dash_code_applied: "Code übernommen!",
        dash_click_add_widget: "Klicke links auf ein Widget um es hinzuzufügen.",
        dash_height: "Höhe:",
        dash_no_widgets: "Keine Widgets — ziehe oder klicke einen Sensor hinein",
        dash_opt_disabled: "— deaktiviert —",
        dash_row: "Reihe",
        dash_color: "Farbe",
        dash_shown_values: "Angezeigte Werte",
        dash_no_screen: "Kein Screen vorhanden",
        dash_screen_name_ph: "Screen-Name",
        dash_template: "Vorlage",
        dash_opt_sensor_field: "— Sensor / Feld wählen —",
        dash_opt_sensor_group: "— Sensor-Gruppe wählen —",
        dash_roll_topic: "Roll-Topic",
        dash_opt_roll: "— Roll auswählen —",
        dash_pitch_topic: "Pitch-Topic",
        dash_opt_pitch: "— Pitch auswählen —",
        dash_opt_impact: "— Impact-Topic —",
        dash_saved: "Dashboard gespeichert!",
        dash_save_error: "Fehler beim Speichern",
        dash_dsl_grid: "GRID &lt;spalten&gt;",
        dash_dsl_sensor: "SENSOR &lt;pfad&gt;",
        dash_dsl_gauge: "GAUGE &lt;pfad&gt;",
        dash_dsl_sensor_opts: "Sensor-Optionen:",
        dash_dsl_gauge_opts: "Gauge-Optionen:",
        dash_dsl_gauge_styles: "Gauge-Styles:",
        dash_dsl_colors: "Farben:",
        dash_dsl_special: "Spezial-Widgets:",
        dash_dsl_screen_fmt: "SCREEN/LAYOUT Format (neu):",
        dash_dsl_templates: "Verfügbare Vorlagen:",
        // Routing tab
        ...
        settings_sys_helm_display: "Touchscreen erkannt",
    ...
    en: {
        ...
        settings_elwis_desc: "Official inland waterway charts from ELWIS",
        loading_ellipsis: "Loading…",
        uploading_ellipsis: "Uploading…",
        upload_arrow: "⬆ Upload",
        routing_region_h: "Routing region",
        routing_region_desc: "Which routing graph is loaded in the OSRM service. Switching is reboot-safe.",
        routing_active_label: "Active:",
        routing_switch: "Switch",
        routing_data_h: "Routing data (cross-border)",
        routing_data_desc: "Upload .routing files from the MBTiles Creator — enables routes across country borders.",
        routing_choose_file: "📂 Choose .routing file",
        routing_osrm_server: "OSRM Server",
        routing_server_url: "Server URL",
        routing_api_key: "API Key",
        routing_gh_free_ph: "Free at graphhopper.com",
        routing_gh_register: "🔗 Register an API key at graphhopper.com (500 requests/day free)",
        routing_current_desc: "Accounts for current speeds for more accurate ETA calculations",
        routing_waterways_h: "Waterways",
        routing_add_waterway: "+ Waterway",
        routing_geo_hint: "Current in <strong>km/h</strong>. Via 🌍 also set the geography: the <em>bounding box</em> limits where the waterway can be, the <em>mouth</em> determines the flow direction (up/downstream). Empty geo fields = built-in default.",
        routing_default_by_type: "Default by type",
        type_river: "River",
        type_canal: "Canal",
        type_stream: "Stream",
        type_lake: "Lake",
        routing_calc_info: "<strong>ℹ️ Calculation:</strong><br>• Downstream: speed + current<br>• Upstream: speed − current<br>• Live data from PEGELONLINE (if available)",
        ...
        data_lock_db_desc: "Manage the lock database: OSM import, data enrichment and quality check.",
        data_import_osm_desc: "Loads locks from OpenStreetMap for all active map regions",
        data_enrich_desc: "Adds VHF channels, contact details and more info",
        data_quality_desc: "Shows data quality statistics (VHF coverage, contacts, etc.)",
        data_verify_desc: "Checks all lock positions against OpenStreetMap and fixes errors (>500m deviation)",
        data_quality_report_h: "📊 Data Quality",
        // Dashboard editor
        dash_tab_visual: "🎨 Visual",
        dash_tab_code: "📝 Code",
        dash_tab_sensors: "📡 Sensors",
        dash_mqtt_hint: "All known MQTT topics. Remove stale entries here.",
        dash_refresh: "🔄 Refresh",
        dash_loading: "Loading…",
        dash_topic_remove_confirm: "Remove topic?",
        dash_error: "Error",
        dash_choose_widget: "Choose widget type",
        dash_w_sensor: "Sensor card",
        dash_w_sensor_desc: "Shows the current value as a card",
        dash_w_gauge_desc: "Dial or arc display",
        dash_cancel: "Cancel",
        dash_apply: "✓ Apply",
        dash_reset: "↺ Reset",
        dash_no_sensors_known: "No sensors known.",
        dash_no_sensors_load: "No sensors — open the Sensors tab to load.",
        dash_special_label: "Special",
        dash_code_applied: "Code applied!",
        dash_click_add_widget: "Click a widget on the left to add it.",
        dash_height: "Height:",
        dash_no_widgets: "No widgets — drag or click a sensor in here",
        dash_opt_disabled: "— disabled —",
        dash_row: "Row",
        dash_color: "Color",
        dash_shown_values: "Shown values",
        dash_no_screen: "No screen present",
        dash_screen_name_ph: "Screen name",
        dash_template: "Template",
        dash_opt_sensor_field: "— Choose sensor / field —",
        dash_opt_sensor_group: "— Choose sensor group —",
        dash_roll_topic: "Roll topic",
        dash_opt_roll: "— Choose roll —",
        dash_pitch_topic: "Pitch topic",
        dash_opt_pitch: "— Choose pitch —",
        dash_opt_impact: "— Impact topic —",
        dash_saved: "Dashboard saved!",
        dash_save_error: "Error while saving",
        dash_dsl_grid: "GRID &lt;columns&gt;",
        dash_dsl_sensor: "SENSOR &lt;path&gt;",
        dash_dsl_gauge: "GAUGE &lt;path&gt;",
        dash_dsl_sensor_opts: "Sensor options:",
        dash_dsl_gauge_opts: "Gauge options:",
        dash_dsl_gauge_styles: "Gauge styles:",
        dash_dsl_colors: "Colors:",
        dash_dsl_special: "Special widgets:",
        dash_dsl_screen_fmt: "SCREEN/LAYOUT format (new):",
        dash_dsl_templates: "Available templates:",
        // Routing tab
        ...
        settings_sys_helm_h4: "Helm (Touchscreen App)",
        settings_sys_helm_display: "Touchscreen detected",
...
function applyI18n(root = document) {
    ...
    // Update rich text (Strings mit Inline-HTML wie <strong>/<em>) — setzt innerHTML
    // statt textContent, damit gemischter Inhalt uebersetzbar bleibt.
