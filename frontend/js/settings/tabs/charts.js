...
export const html = `
                ...
                <div class="setting-group">
                    ...
                    <p style="font-size: 12px; color: #8892b0; margin-bottom: 10px;" data-i18n="settings_elwis_desc">Offizielle Binnenschifffahrtskarten von ELWIS</p>
                    ...
                    <div id="enc-catalog-list" style="max-height: 300px; overflow-y: auto; background: rgba(0,0,0,0.3); padding: 15px; border-radius: 8px; margin-bottom: 15px;">
                        <div style="color: #8892b0; text-align: center; padding: 20px;" data-i18n="click_load_catalog">Klicke "Katalog laden" um verfügbare ENC anzuzeigen</div>
                    </div>
