...
**[⬇️ Download v1.9.0 (~8.8 GB)](https://archive.org/download/boatos-distri-image/boatos_v1.9.0.img.gz)**
...
1. **Download image** (v1.9.0): [boatos_v1.9.0.img.gz](https://archive.org/download/boatos-distri-image/boatos_v1.9.0.img.gz) (~8.8 GB)
...
- ~~Distributable Pi image~~ ✅ [Ready-to-flash image available](https://archive.org/download/boatos-distri-image/boatos_v1.9.0.img.gz)
